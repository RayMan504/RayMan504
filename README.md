...
|---------|-------------|------|
| [Mortgage Automation - Repo is private] | Automated mortgage loan underwriting using Azure Functions. Streamlined large document downloads with real-time streaming. | C#, Node.js, Azure Functions, Blob Storage |
| [Blood Type Compatibility Service](https://github.com/RayMan504/BloodMatchApi) | Simple Web API that validates compatibility of a given blood type. | C#, Typescript |
